...
namespace Scrabble.Domain.Tests
{
    public class PlayerTests
    {
        ...
        //    var (_,emptyTileBag) = startingTileBag.DrawTiles(new TileDrawCount( startingTileBag.Count)); // Empty the tile bag
        ...
        //    tileBag.DrawTiles(new TileDrawCount( tilesLeftInBag - 3));
